...
//  SECURITY MODEL
//  ──────────────
//  • The edit button is invisible to everyone by default.
//  • To access edit mode, navigate to:
//      yoursite.com/#admin
//    A password prompt appears. Only the owner knows the password.
...
//
//  IMAGES (why recruiters can't see your photos)
//  ─────────────────────────────────────────────
//  Images uploaded through the browser are saved in IndexedDB,
//  which is LOCAL to your browser only. To make images visible
//  to everyone, you must host them externally:
//    1. Go to cloudinary.com → free account → upload your image
//    2. Copy the image URL Cloudinary gives you
//    3. Enter that URL when the site asks for an image URL
//  The site will then save the URL (not the file) so ALL visitors
//  see the same image from Cloudinary.
// ─────────────────────────────────────────────────────────────
...
window.addEventListener('load', async function() {
  // Check for #admin BEFORE cleaning hash
